...
δ_param = OptimizationParameter("δ",                x_opt[1],   (1.05, 1.5),        false)
a_param = OptimizationParameter("a",                x_opt[2],   (1.0e-5, 1.0e-3),   false)
β_param = OptimizationParameter("β",                x_opt[3],   (0.0, 0.01),        false)
A_spring_param = OptimizationParameter("A_spring",  x_opt[4],   (0.1, 3.0),         false)
